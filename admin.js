...
// FUNCTION TO DISPLAY PROPERTIES USING A LOOP AND A TEMPLATE LITERATE
// *******************************************************************
function showAdminProperties() {
  let prop = document.getElementById("tblContent");
  prop.innerHTML = "";
  properties.forEach((property, index) => {
    ...
    <td><svg xmlns="http://www.w3.org/2000/svg" width="16" type="button" id="btnDelete" onclick="deleteProperty(${index})" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
...
// FUNCTION TO ADD A PROPERTY ON THE ADMIN PAGE
// ****************************************************************
...
// EVENTLISTENER TO CALL THE ADD FUNCTION WHEN THE BUTTON IS CLICKED
// *********************************************************************
document
  .querySelector(".btnAddProperty")
  .addEventListener("click", addProperties);

// FUNCTION TO DELETE A PROPERTY ON THE ADMIN PAGE
// ****************************************************************
...
// EVENTLISTENER TO CALL THE DELETE FUNCTION WHEN THE BUTTON IS CLICKED
// *********************************************************************
// document
